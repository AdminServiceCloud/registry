...
> 🌍 Русская версия: [docs/russian/CODE_OF_CONDUCT.md](docs/russian/CODE_OF_CONDUCT.md)

## 🌟 Our pledge

We as members, contributors, and leaders pledge to make participation in the **AdminService.Cloud registry** community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers via any of the contact channels listed in the [asc-daemon Support](https://github.com/AdminServiceCloud/asc-daemon#-support) section. All complaints will be reviewed and investigated promptly and fairly. All maintainers are obligated to respect the privacy and security of the reporter of any incident.
